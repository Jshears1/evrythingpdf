...
const V = 'epdf-v1';
const CORE = ['/', '/edit-text.html', '/add-text.html', '/metadata.html', '/fill-form.html', '/redact.html', '/crop.html', '/organize.html', '/editor.js', '/style.css', '/manifest.webmanifest', '/icon.svg'];
